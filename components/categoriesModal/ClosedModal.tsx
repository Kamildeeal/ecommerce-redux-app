  ...
  return (
    ...
    <div className="overflow-auto">
      <div
        ...
        className="z-[35] fixed top-0 left-0 w-[60px] max-h-max bg-gray-200 border-l-2 border-gray-800 rounded-r-xl my-[15vh]"
      >
        <div className="py-6 px-1 flex flex-col h-full">
